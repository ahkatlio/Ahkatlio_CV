...
\begin{itemize}
    ...
    \project
        ...
        {Built a YOLOv8-based model to detect and classify 36 fruit and vegetable classes with 91.68\% mAP, optimized for real-time agricultural applications.}
...
\section{Education}
{\small
\educationentry{Bachelor of Science - Applied Physics and Electronics}{BRAC University}{Dhaka, Bangladesh}
Currently pursuing
\par
\vspace{3.0mm}
